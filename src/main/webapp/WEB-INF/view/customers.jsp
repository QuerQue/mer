...
<form:form method="GET" action="${contextPath}${customersUrl}" modelAttribute="CustomerSearch">
    <div class="row">
        ...
        <div class="col-md-3">
            <form:label path="personalId" class="control-label"><spring:message text="ID" /></form:label>
            <form:input type="number" class="form-control" path="personalId" />
        </div>
        <div class="col-md-3">
            <form:label path="address" class="control-label"><spring:message text="Status" /></form:label>
