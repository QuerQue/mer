    ...
    <div class="col-md-6">
        ...
        <form:form action="${contextPath}${customerUrl}" commandName="customer" class="form-horizontal">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <form:label path="name" class="col-lg-3 control-label"><spring:message text="Login" /></form:label>
                <div class="col-lg-9">
                    <form:input path="name" class="form-control" />
                </div>
            </div>
            <div class="form-group">
                <form:label path="personalId" class="col-lg-3 control-label"><spring:message text="Password" /></form:label>
                <div class="col-lg-9">
            ...
            <div class="form-group">
                <form:label path="address" class="col-lg-3 control-label"><spring:message text="Address Email" /></form:label>
                <div class="col-lg-9">
                    <form:input path="address" type="text" class="form-control"/>
                </div>
            </div>
            <div class="form-group">
                <form:label path="address" class="col-lg-3 control-label"><spring:message text="Phone Number" /></form:label>
                <div class="col-lg-9">
                    <form:input path="address" type="text" class="form-control"/>
                </div>
            </div> 
